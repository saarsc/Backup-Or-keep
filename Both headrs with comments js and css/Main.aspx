...
<body>
  ...
  <li><a href="#">שני</a>
    ...
    <!--The page info-->
    <center>
        <p>The drum is the oldest known instrument in the world dating back to 4000 BC in Egypt.[4] Drums made with alligator skins have been found in Neolithic cultures located in China, dating to a period of 5500–2350 BC. In literary records, drums manifested shamanistic characteristics were often used in ritual ceremonies.[5]
...
During pre-Columbian warfare, Aztec nations were known to have used drums to send signals to the battling warriors. The Nahuatl word for drum is roughly translated as huehuetl.[11]
...
Prior to the invention of tension rods, drum skins were attached and tuned by rope systems—as on the Djembe—or pegs and ropes such as on Ewe Drums. These methods are rarely used today, though sometimes appear on regimental marching band snare drums.[1] The head of a talking drum, for example, can be temporarily tightened by squeezing the ropes that connect the top and bottom heads. Similarly, the tabla is tuned by hammering a disc held in place around the drum by ropes stretching from the top to bottom head. Orchestral timpani can be quickly tuned to precise pitches by using a foot pedal.Drums are usually played by striking with the hand, or with one or two sticks. In many traditional cultures, drums have a symbolic function and are used in religious ceremonies. Drums are often used in music therapy, especially hand drums, because of their tactile nature and easy use by a wide variety of people.[2]
...
Many drummers extend their kits from this basic pattern, adding more drums, more cymbals, and many other instruments including pitched percussion. In some styles of music particular extensions are normal, for example double bass drums in heavy metal music and the enlarged kits used by some progressive rock drummers, which may include unusual instruments such as gongs. Some performers use small kits that omit elements from the basic setup, such as some rockabilly drummers. Some drum kit players may have other roles in the band, such as providing backup vocals, or less commonly, lead vocals.
        ...
        <p id="Second">Prior to the development of the drum set, the standard way that drums and cymbals were used in military and orchestral music settings was to have the different drums and cymbals played separately by different percussionists. Thus, in an early 1800s orchestra piece, if the score called for bass drum, triangle and cymbals, three percussionists would be hired to play these three instruments. In the 1840s, percussionists began to experiment with foot pedals as a way to enable them to play more than one instrument. In the 1860s, percussionists began to experiment with combining multiple drums into a set. The bass drum, snare drum, cymbals, and other percussion instruments were all played using hand-held drum sticks. Drummers in musical theater shows and stage shows, where the budget for pit orchestras were often limited, contributed to the creation of the drum set because they tried to develop ways so that one drummer could do the job of multiple percussionists.

Double-drumming was developed to enable one person to play the bass and snare with sticks, while the cymbals could be played by tapping the foot on a "low-boy". With this approach, the bass drum was usually played on beats one and three (in 4/4 time). While the music was first designed to accompany marching soldiers, this simple and straightforward drumming approach eventually led to the birth of ragtime music when the simplistic marching beats became more syncopated. This resulted in a greater 'swing' and dance feel. The drum set was initially referred to as a "trap set," and from the late 1800s to the 1930s, drummers were referred to as "trap drummers." By the 1870s, drummers were using an "overhang pedal." Most drummers in the 1870s preferred to do double drumming without any pedal to play multiple drums, rather than use an overhang pedal. Companies patented their pedal systems such as Dee Dee Chandler of New Orleans 1904–05.[7] Liberating the hands for the first time, this evolution saw the bass drum played with the foot of a standing percussionist (thus the term "kick drum"). The bass drum became the central piece around which every other percussion instrument would later revolve.

Ludwig-Musser, William F. Ludwig, Sr., and his brother, Theobald Ludwig, founded the Ludwig & Ludwig Co. in 1909 and patented the first workable bass drum pedal system, paving the way for the modern drum kit.[8] It was the golden age of drum building for many famous drum companies, with Ludwig introducing... "The ornately engraved Black Beauty Brass Snare drum; Slingerland premiered its Radio King solid-maple shell; Leedy invented the floating drum head & self-aligning lug;& Gretsch originated the three-way tension system of the Gladstone snare drum".[9] Wire brushes for use with drums and cymbals were introduced in 1912. The need for brushes arose due to the problem of the drum sound overshadowing the other instruments on stage. Drummers began using metal fly swatters to reduce the volume on stage next to the other acoustic instruments. Drummers could still play the rudimentary snare figures and grooves with brushes they would normally play with drumsticks. As brushes gained popularity, the drum companies started manufacturing brushes.
        </p>
        </center>
    <!--Back to the top button-->
    <a href="#" class="back-to-top"></a>
<footer>
                האתר הזה הוא חלק מפרייקט ההגשה של סער 
    </footer>
</body>
</html>
<!-- 
